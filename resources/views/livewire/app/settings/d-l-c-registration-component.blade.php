<div>
    <main class="main_content_wrapper setting_content_wrapper">
        ...
        <section class="dcl_regisgtration_wrapper account_border">
          <div class="account_title_area">
            <div class="d-flex align-items-center flex-wrap g-sm">
              <button type="button" class="sidebar_open_btn" id="sidebarShowBtn">
                <img
                  src="{{ asset('assets/app/icons/back-double-arrow.svg') }}"
                  alt="double arrow"
                />
              </button>
              <img
                src="{{ asset('assets/app/icons/log-out.svg') }}"
                alt="log out icon"
                class="user_icon"
              />
          ...
          <ul class="nav nav-pills mt-24" id="pills-tab" role="tablist">
                ...
                <div class="register_group">
                  ...
                  <div class="two_grid">
                    <div class="input_row searchable_select">
                      ...
                      <img
                        src="{{ asset('assets/app/icons/arrow-down.svg') }}"
                        alt="down arrow"
                        class="down_arrow"
                      />
                    </div>
                ...
                <div class="register_group">
                  ...
                  <div class="input_row">
                    ...
                    <textarea
                      ...
                      rows="4"
                      class="input_field"
                      placeholder="Please tell us about your requirement in details"
                    ></textarea>
                  </div>
                  <div class="input_row">
                    ...
                    <textarea
                      ...
                      rows="4"
                      class="input_field"
                      placeholder="Type Sample message 1"
                    ></textarea>
                  </div>
                  <div class="input_row">
                    ...
                    <textarea
                      ...
                      rows="4"
                      class="input_field"
                      placeholder="Type Sample message 2"
                    ></textarea>
                  </div>
                </div>
                <div class="register_group">
                    ...
                    <div class="check_area">
                      <div class="form-check">
                        <input
                          class="form-check-input"
                          type="radio"
                          name="permissionCheckbox1"
                          id="permissionYesCheckbox11"
                          checked
                        />
                        <label
                          class="form-check-label"
                          for="permissionYesCheckbox11"
                        >
                          Yes
                        </label>
                      </div>
                    ...
                    <div class="check_area">
                      <div class="form-check">
                        <input
                          class="form-check-input"
                          type="radio"
                          name="permissionCheckbox2"
                          id="permissionYesCheckbox21"
                          checked
                        />
                        <label
                          class="form-check-label"
                          for="permissionYesCheckbox21"
                        >
                          Yes
                        </label>
                      </div>
                    ...
                    <div class="check_area">
                      <div class="form-check">
                        <input
                          class="form-check-input"
                          type="radio"
                          name="permissionCheckbox3"
                          id="permissionYesCheckbox31"
                          checked
                        />
                        <label
                          class="form-check-label"
                          for="permissionYesCheckbox31"
                        >
                          Yes
                        </label>
                      </div>
                    ...
                    <div class="check_area">
                      <div class="form-check">
                        <input
                          class="form-check-input"
                          type="radio"
                          name="permissionCheckbox4"
                          id="permissionYesCheckbox41"
                          checked
                        />
                        <label
                          class="form-check-label"
                          for="permissionYesCheckbox41"
                        >
                          Yes
                        </label>
                      </div>
                    ...
                    <div class="check_area">
                      <div class="form-check">
                        <input
                          class="form-check-input"
                          type="radio"
                          name="permissionCheckbox6"
                          id="permissionYesCheckbox61"
                        />
                        <label
                          class="form-check-label"
                          for="permissionYesCheckbox61"
                        >
                          Yes
                        </label>
                      </div>
                      <div class="form-check">
                        <input
                          ...
                          type="radio"
                          name="permissionCheckbox6"
                          id="permissionYesCheckbox62"
                          checked
                        />
                        <label
                          class="form-check-label"
                          for="permissionYesCheckbox62"
                        >
                          No
                        </label>
                      </div>
                    ...
                    <div class="check_area">
                      <div class="form-check">
                        <input
                          class="form-check-input"
                          type="radio"
                          name="permissionCheckbox7"
                          id="permissionYesCheckbox71"
                        />
                        <label
                          class="form-check-label"
                          for="permissionYesCheckbox71"
                        >
                          Yes
                        </label>
                      </div>
                      <div class="form-check">
                        <input
                          ...
                          type="radio"
                          name="permissionCheckbox7"
                          id="permissionYesCheckbox72"
                          checked
                        />
                        <label
                          class="form-check-label"
                          for="permissionYesCheckbox72"
                        >
                          No
                        </label>
                      </div>
                    ...
                    <div class="check_area">
                      <div class="form-check">
                        <input
                          class="form-check-input"
                          type="radio"
                          name="permissionCheckbox8"
                          id="permissionYesCheckbox81"
                        />
                        <label
                          class="form-check-label"
                          for="permissionYesCheckbox81"
                        >
                          Yes
                        </label>
                      </div>
                      <div class="form-check">
                        <input
                          ...
                          type="radio"
                          name="permissionCheckbox8"
                          id="permissionYesCheckbox82"
                          checked
                        />
                        <label
                          class="form-check-label"
                          for="permissionYesCheckbox82"
                        >
                          No
                        </label>
                      </div>
                  ...
                  <div class="input_row">
                    <label for=""
                      >Additional Recipients to Email on 10DLC Registration
                      Updates</label
                    >
                    <input
                      type="text"
