                                ...
                                <div class="acitivity_item">
                                    ...
                                    <div>
                                        ...
                                        @if ($activity->direction == 'inbound')
                                            <h5>Message received from <strong>{{ $activity->contact_id ? getContactNumberName($activity->contact_id)->first_name : '' }} {{ $activity->contact_id ? getContactNumberName($activity->contact_id)->last_name : '' }}</strong></h5>
                                        @else
                                            <h5>Message sent to <strong>{{ $activity->contact_id ? getContactNumberName($activity->contact_id)->first_name : '' }} {{ $activity->contact_id ? getContactNumberName($activity->contact_id)->last_name : '' }}</strong></h5>
                                        @endif
                                    </div>
                                </div>
                            @endforeach
