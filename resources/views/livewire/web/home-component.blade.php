                    ...
                    <div class="col-12">
                        ...
                        <div class="campaign_grid dynamic_item">
                            <div class="content" data-aos="fade-left">
                                ...
                                <h5>
                                    Deliver messages that resonate by using dynamic fields to
                                    personalize content for each recipient, from names to
                                    purchase history.
                                </h5>
                            </div>
                            <div class="campaign_image" data-aos="fade-right">
                                <img src="{{ asset('assets/app/images/landing/DP.png') }}" alt="dp image" />
                            </div>
                        </div>
                        <div class="campaign_grid campaign_left_grid compliance_item">
                            <div class="content" data-aos="slide-up">
                                ...
                                <h5>
                                    Stay compliant with industry regulations and protect your
                                    customer data with our built-in security features. Our
                                    platform ensures every message meets regulatory standards."
                                </h5>
                            </div>
                            <div class="campaign_image" data-aos="fade-right">
                                <img src="{{ asset('assets/app/images/landing/compliance.png') }}"
                        ...
                        <div class="campaign_grid campaign_left_grid message_item">
                            <div class="content" data-aos="fade-down-right">
                                ...
                                <h5>
                                    Choose from industry-specific templates that are designed to
                                    engage your audience effectively. Whether you’re in retail,
                        ...
                        <div class="campaign_grid real_time_item">
                            <div class="content" data-aos="fade-left">
                                <div class="icon">
                                    <img src="{{ asset('assets/app/icons/campaings-icon4.svg') }}"
                                        alt="custom template icon" />
                                </div>
                                <h3>Real-Time Delivery Insights</h3>
                                <h5>
                                    Monitor the delivery status of your SMS campaigns in real
                                    time. Instantly see who has received, opened, and engaged
                                    with your messages.
                                </h5>
                            </div>
                        ...
                        <div class="campaign_grid campaign_left_grid automated_item">
                            <div class="content" data-aos="fade-down-left">
                                ...
                                <h5>
                                    Set up automated follow-up messages based on customer
                                    interactions. Keep the conversation going without lifting a
                                    finger.
                                </h5>
                            </div>
                        ...
                        <div class="campaign_grid api_time_item">
                            <div class="content" data-aos="fade-up-left">
                                ...
                                <h5>
                                    Easily connect your preferred SMS gateway, whether it’s
                                    Twilio, Telnyx, Trumpia, Plivo, or another provider. Our
                                    platform is designed to seamlessly integrate with your
                                    existing API setup, allowing you to send thousands or
