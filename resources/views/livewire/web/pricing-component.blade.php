<div>
    <main>
        <!-- Hero Section  -->
        <section
          class="hero_wrapper hero_wrapper_others"
                    ...
                    <div class="pricing_item">
                      ...
                      <ul>
                        <li>
                          <div class="icon">
                            <img
                              src="{{ asset('assets/app/icons/entypo_check.svg') }}"
                              alt="check icon"
                            />
                          </div>
                          <h4>7,000 credits</h4>
                    ...
                    <div class="pricing_item premium_pricing_item">
                      ...
                      <ul>
                        <li>
                          <div class="icon">
                            <img
                              src="{{ asset('assets/app/icons/entypo_check-white.svg') }}"
                              alt="check icon"
                            />
                          </div>
              ...
              <div class="col-12">
                <div class="campaign_grid dynamic_item mt-0">
                  <div class="content">
                    <div class="icon">
                      <img
                        src="{{ asset('assets/app/icons/campaings-icon6.svg') }}"
                        alt="campaigns icon"
                      />
                    </div>
                  ...
                  <div class="campaign_image text-md-end">
                    <img
                      src="{{ asset('assets/app/images/landing/why-platform.png') }}"
                      alt="dp image"
        ...
        <section class="ready_start_wrapper">
          ...
          <img
            src="{{ asset('assets/app/images/landing/Background-Integrations.png') }}"
            alt="ready start curve"
