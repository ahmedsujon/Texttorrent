...
<head>
    ...
    <title>Text Torrent - 402 Payment Required</title>
    ...
    <div class="custom-bg text-dark">
        <div class="d-flex align-items-center justify-content-center min-vh-100 px-2">
            <div class="text-center">
                ...
                <p class="fs-2 fw-medium mt-4">Oops! Payment Required</p>
                <p class="mt-4 mb-5">Your account needs to be updated with payment information in order to proceed.</p>
