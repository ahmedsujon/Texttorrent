...
<head>
    ...
    <title>Text Torrent - 419 Page Expired</title>
    ...
    <div class="custom-bg text-dark">
        <div class="d-flex align-items-center justify-content-center min-vh-100 px-2">
            <div class="text-center">
                ...
                <p class="fs-2 fw-medium mt-4">Oops! Page Expired</p>
                <p class="mt-4 mb-5">Your session has expired. Please refresh the page and try again.</p>
