...
<head>
    ...
    <title>Text Torrent - 429 Too Many Requests</title>
    ...
    <div class="custom-bg text-dark">
        <div class="d-flex align-items-center justify-content-center min-vh-100 px-2">
            <div class="text-center">
                ...
                <p class="fs-2 fw-medium mt-4">Oops! 429 Too Many Requests</p>
                <p class="mt-4 mb-5">You're sending too many requests in a short period of time. Please try again later.
                </p>
