...
<head>
    ...
    <title>Text Torrent - 503 Service Unavailable</title>
    ...
    <div class="custom-bg text-dark">
        <div class="d-flex align-items-center justify-content-center min-vh-100 px-2">
            <div class="text-center">
                ...
                <p class="fs-2 fw-medium mt-4">Oops! Service Unavailable</p>
                <p class="mt-4 mb-5">We're currently undergoing maintenance. Please try again later.</p>
